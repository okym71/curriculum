...
public class Task1_4 {
    ...
    private static final String USER_NAME = "okuyama";
    private static final String USER_PASSWORD = "takaaki";
    ...
    public static void main(String[] args) {
       ...
       //     定数を使用して「 パスワードに誤りがあります。 」 と出力してください。
         elseif(name.equals(USER_NAME) && pass != USER_PASSWORD){
            System.out.println(CONST_MSG_ERROR_NAME);
        }

        // ④ 「USER_PASSWORD」の値のみ等しい場合。
       //定数を使用して「 名前に誤りがあります。 」と出力してください。
         elseif(name.equals(USER_NAME) && pass.equals(USER_PASSWORD)){
